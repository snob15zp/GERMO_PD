...
#ifndef _CYHAL_CCG7S_40_QFN_H_
#define _CYHAL_CCG7S_40_QFN_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_ccg7s_40_qfn CCG7S 40-QFN
...
/** Definitions for all of the pins that are bonded out on in the 40-QFN package for the CCG7S series. */
typedef enum {
...
} cyhal_gpio_ccg7s_40_qfn_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_ccg7s_40_qfn_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_dsi_sar_data[5];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_ext_hs1[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_ext_hs2[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_ext_hsrcp[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_ext_ls1[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_ext_ls2[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_ext_lszcd[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_ext_pwm_out[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_ext_rst_sw1[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_ext_scap_rst[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_ext_scomp_out_en[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_ext_set_boost[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_ext_set_buck[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_pad_bat2gnd_pulldn[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_pad_lscsa_inp[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_pad_lscsa_vgnd[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_usbphy_dm_bch_det[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_usbpd_usbphy_dp_bch_det[1];

...
#define CYHAL_PIN_MAP_DRIVE_MODE_CAN_CAN_RX (CY_GPIO_DM_HIGHZ)
...
#define CYHAL_PIN_MAP_DRIVE_MODE_CAN_CAN_TX (CY_GPIO_DM_STRONG_IN_OFF)
...
#define CYHAL_PIN_MAP_DRIVE_MODE_CAN_CAN_TX_ENB_N (CY_GPIO_DM_STRONG_IN_OFF)
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lpcomp_dsi_comp[4];

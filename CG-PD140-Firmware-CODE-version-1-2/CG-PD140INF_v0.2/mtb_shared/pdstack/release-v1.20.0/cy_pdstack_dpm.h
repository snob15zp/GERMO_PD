...
*
*******************************************************************************/
void Cy_PdStack_Dpm_UpdateUsbComm (
        cy_stc_pdstack_context_t *ptrPdStackContext,
        uint8_t state);
...
****************************************************************************//**
*
* Function to update Sink USB Suspend Enable bit.
*
* \param ptrPdStackContext
* PdStack Library Context pointer.
*
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_SetBCRFaultStat (
        cy_stc_pdstack_context_t *ptrPdStackContext,
        uint8_t value);
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_ClearBCRFaultStat (
        cy_stc_pdstack_context_t *ptrPdStackContext,
        uint8_t value);
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_SetBistStmEn (
        cy_stc_pdstack_context_t *ptrPdStackContext,
        bool value);
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_UpdateExtSrcCap (
        cy_stc_pdstack_context_t *ptrPdStackContext, 
        uint8_t *ptrBuf);

/*******************************************************************************
* Function Name: Cy_PdStack_Dpm_NotifyAppWdata
****************************************************************************//**
*
* This is a wrapper function for application events with data
*
* \param ptrPdStackContext
* PdStack Library Context pointer.
*
* \param evt
* \ref cy_en_pdstack_app_evt_t
*
* \param dat
* Event data
*
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_NotifyAppWdata (
        cy_stc_pdstack_context_t *ptrPdStackContext,
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_ClearFaultActive (
        cy_stc_pdstack_context_t *ptrPdStackContext);
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_UpdateFrsEnable (
        cy_stc_pdstack_context_t *ptrPdStackContext, 
        bool frsRxEn, 
        bool frsTxEn);
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_ClearHardResetCount (
        cy_stc_pdstack_context_t *ptrPdStackContext);
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_SetDelaySrcCapStart (
        cy_stc_pdstack_context_t *ptrPdStackContext,
        uint16_t delay);
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_UpdateExtSnkCap (
        cy_stc_pdstack_context_t *ptrPdStackContext, 
        uint8_t *ptrBuf);
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_SetFaultActive (
        cy_stc_pdstack_context_t *ptrPdStackContext);
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_SetChunkXferRunning (
        cy_stc_pdstack_context_t *ptrPdStackContext, 
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_UpdatePortStatus(
        cy_stc_pdstack_context_t *ptrPdStackContext,
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_UpdateAutoVcsEnable(cy_stc_pdstack_context_t *ptrPdStackContext, bool val);
...
*
*******************************************************************************/
void Cy_PdStack_Dpm_UpdateVconnRetain(cy_stc_pdstack_context_t *ptrPdStackContext, uint8_t val);

/*******************************************************************************
* Function Name: Cy_PdStack_Dpm_SetDataReset
****************************************************************************//**
*
* Function to enable/disable the Data Reset support.
*
* \param ptrPdStackContext
* PdStack Library Context pointer.
*

...
* 5. ccg7s_pd3_src - Library with support for USB Type-C source operation
* and USB-PD Revision 3.1 messaging.
********************************************************************************
...
*    * Add 'CCG7S_PD3_SRC' to the COMPONENTS for using the ccg7s_pd3_src library
...
/** Sender response timeout period in ms. See Section 6.6.2 of USBPD Spec Rev3 v1.4 */
#define CY_PD_SENDER_RESPONSE_TIMER_PERIOD     (28u)
...
typedef enum
{
    ...
    CY_PDSTACK_DPM_CMD_SEND_EPR_REQUEST,           /**< 20: Send EPR Request message. */

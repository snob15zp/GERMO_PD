...
*              module as part of the PMG1 MCU USBPD DRP Example for
*              ModusToolBox.
*
...
#define CHGDET_EVT_ALL_MASK             (0xFFFFFFFFu)
/*******************************************************************************
...
typedef enum{
    ...
    CHGDET_FSM_SRC_LOOK_FOR_CONNECT,                    /**< Look for connection as a DCP. */
    CHGDET_FSM_SRC_INITIAL_CONNECT,                     /**< Initial BC1.2 sink connection detected. */
    CHGDET_FSM_SRC_CDP_CONNECTED,                       /**< Port configured as a Charging Downstream Port (CDP). */
...
typedef struct {
    ...
    chgdet_src_charge_mode_t src_mode;          /**< Active charging scheme. */

/******************************************************************************
* File Name: vdm_task_mngr.c
*
* Description: This file implements the VDM manager functionality.
*
            ...
            if (rec_vdm->dat[VDM_HEADER_IDX].std_vdm_hdr.vdmType == VDM_TYPE_STRUCTURED)
            {
                ...
                if (rec_vdm->sop == SOP)
                {
                    app_get_status(port)->vdm_version =
                        GET_MIN (app_get_status(port)->vdm_version, rec_vdm->dat[VDM_HEADER_IDX].std_vdm_hdr.stVer);
                }
        ...
        case VDM_EVT_EVAL:
            ...
            if (gl_dpm_port_type[port] != PRT_TYPE_UFP)
            {
                   ...
                   )
                {
                    ...
                    {
                        /*
                         * Discovery process couldn't be run if Alternate Modes field in 
